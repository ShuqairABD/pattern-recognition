...
# ── Kaleido config for cloud servers (Render, etc.) ──────
# Allows chart screenshots without sandbox (needed on Linux servers)
try:
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            # Language switcher
            html.Div([
                dbc.Button("🇬🇧 EN", id="btn-lang-en", color="outline-light",
                           size="sm", className="me-1",
                           style={"fontSize":"12px","padding":"3px 10px"}),
                dbc.Button("🇸🇦 AR", id="btn-lang-ar", color="outline-light",
                           size="sm",
                           style={"fontSize":"12px","padding":"3px 10px"}),
